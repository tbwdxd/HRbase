...
CREATE TABLE Talent (TalentID INT NOT NULL identity(1,1), PersonID INT NOT NULL, LastName VARCHAR(50) NOT NULL, 
	...
	PRIMARY KEY(TalentID), FOREIGN KEY(PersonID) REFERENCES Users(PersonID));

#3.3 In the 'Employee' table  Information, the primary key is 'EmployeeID', foreign key is 'PersonID'
CREATE TABLE Employee (EmployeeID INT NOT NULL identity(1,1), PersonID INT NOT NULL, LastName VARCHAR(50),
	FirstName VARCHAR(50), Department VARCHAR(50) NOT NULL, WorkPhone VARCHAR(25) NOT NULL, Position VARCHAR(50),
	PRIMARY KEY(EmployeeID), FOREIGN KEY(PersonID) REFERENCES Users(PersonID));
...
CREATE TABLE Employment_History (EmploymentID INT NOT NULL, PersonID INT NOT NULL, CompanyID INT NOT NULL, 
	...
	PRIMARY KEY(EmploymentID), FOREIGN KEY(PersonID) REFERENCES Users(PersonID), 
